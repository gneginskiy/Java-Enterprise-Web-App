...
<section>
    ...
    <a class="btn btn-sm btn-info" onclick="filter()"><fmt:message key="meals.filter"/></a>
    <hr>
        ...
        <table class="table table-striped display" id="datatable">
            ...
            <c:forEach items="${meals}" var="meal">
                ...
                <tr class="${meal.exceed ? 'exceeded' : 'normal'}">
                    ...
                    <td>${meal.calories}</td>
                    <td><a class="btn btn-xs btn-primary edit" id="${meal.id}"><fmt:message key="common.update"/></a>
                    </td>
                    <td><a class="btn btn-xs btn-danger delete" id="${meal.id}"><fmt:message key="common.delete"/></a>
                    </td>
                </tr>
            </c:forEach>
        </table>
